...
v1=$(curl -sSL "https://raw.githubusercontent.com/seth42sp/VPS-MX_Oficial/main/SCRIPT-v8.4g%20Oficial/Version")
...
time_reboot() {
  print_center -ama "REINICIANDO VPS EM $1 SEGUNDOS"
  REBOOT_TIMEOUT="$1"
...
repo() {
  link="https://raw.githubusercontent.com/seth42sp/Multi-Script/main/Source-List/$1.list"
  case $1 in
...
post_reboot() {
  echo 'wget -O /root/install.sh "https://raw.githubusercontent.com/seth42sp/VPS-MX_Oficial/main/Instalador/Install-Sin-Key.sh"; clear; sleep 2; chmod +x /root/install.sh; /root/install.sh --continue' >>/root/.bashrc
  title -verd "ATUALIZAÇÃO COMPLETA DO SISTEMA"
  print_center -ama "A instalação continuará\napós a reinicialização!!!"
  msg -bar
}
...
install_continue() {
  os_system
  msg -bar
  echo -e "      \e[5m\033[1;100m   CCONCLUINDO PACOTES PARA O SCRIPT   \033[1;37m"
  msg -bar
...
msg -bar2
print_center -ama "LISTA DE SCRIPTS DISPONÍVEIS"
msg -bar
#-BASH SOPORTE ONLINE
...
install_oficial() {
  ...
  cd /etc
  wget https://raw.githubusercontent.com/seth42sp/VPS-MX_Oficial/main/SCRIPT-v8.4g%20Oficial/VPS-MX.tar.xz >/dev/null 2>&1
  ...
  wget -O /bin/resetsshdrop https://raw.githubusercontent.com/seth42sp/VPS-MX_Oficial/main/LINKS-LIBRERIAS/resetsshdrop &>/dev/null
  chmod +x /bin/resetsshdrop
  grep -v "^PasswordAuthentication" /etc/ssh/sshd_config >/tmp/passlogin && mv /tmp/passlogin /etc/ssh/sshd_config
  echo "PasswordAuthentication yes" -e "\e[1;92m             >> INSTALAÇÃO COMPLETA <<" >>/etc/ssh/sshd_configecho && msg bar2
  rm -rf /usr/local/lib/systemubu1 &>/dev/null
  rm -rf /etc/versin_script &>/dev/null
  v1=$(curl -sSL "https://raw.githubusercontent.com/seth42sp/VPS-MX_Oficial/main/SCRIPT-v8.4g%20Oficial/Version")
  echo "$v1" >/etc/versin_script
  wget -O /etc/versin_script_new https://raw.githubusercontent.com/seth42sp/VPS-MX_Oficial/main/SCRIPT-v8.5x%20Mod/Version &>/dev/null
  ...
  echo 'wget -O /etc/versin_script_new https://raw.githubusercontent.com/seth42sp/VPS-MX_Oficial/main/SCRIPT-v8.4g%20Oficial/Version &>/dev/null' >>.bashrc
  echo 'echo "" ' >>.bashrc
  echo 'mess1="$(less /etc/VPS-MX/message.txt)" ' >>.bashrc
  echo 'echo "" ' >>.bashrc
  echo 'echo -e "\t\033[92mPRO : $mess1 "' >>.bashrc
  echo 'echo -e "\t\e[1;33mVERSION: \e[1;31m$(cat /etc/versin_script_new)"' >>.bashrc
  echo 'echo "" ' >>.bashrc
  echo 'echo -e "\t\033[97mPARA EXIBIR O TIPO DE PAINEL BASH: sudo VPSMX o menu "' >>.bashrc
  echo 'echo ""' >>.bashrc
  ...
  clear && clear
  msg -bar
  echo -e "\e[1;92m             >> INSTALAÇÃO COMPLETA <<" && msg bar2
  echo -e "      COMANDO PRINCIPAL PARA ENTRAR NO PAINELL "
...
install_mod() {
  clear && clear
  msg -bar
  echo -ne "\033[1;97m Digite seu slogan: \033[1;32m" && read slogan
  tput cuu1 && tput dl1
  echo -e "$slogan"
  msg -bar
  clear && clear
  mkdir /etc/VPS-MX >/dev/null 2>&1
  cd /etc
  wget https://raw.githubusercontent.com/seth42sp/VPS-MX_Oficial/main/SCRIPT-v8.5x%20Mod/VPS-MX.tar.xz >/dev/null 2>&1
  tar -xf VPS-MX.tar.xz >/dev/null 2>&1
  chmod +x VPS-MX.tar.xz >/dev/null 2>&1
  rm -rf VPS-MX.tar.xz
  cd
  ...
  rm -rf /usr/local/lib/systemubu1 &>/dev/null
  rm -rf /etc/versin_script &>/dev/null
  v1=$(curl -sSL "https://raw.githubusercontent.com/seth42sp/VPS-MX_Oficial/main/SCRIPT-v8.5x%20Mod/Version")
  echo "$v1" >/etc/versin_script
  wget -O /etc/versin_script_new https://raw.githubusercontent.com/seth42sp/VPS-MX_Oficial/main/SCRIPT-v8.5x%20Mod/Version &>/dev/null
  echo '#!/bin/sh -e' >/etc/rc.local
  sudo chmod +x /etc/rc.local
  ...
  echo 'echo -e "\t\033[91m   \ V / |  __/ ___) |_____| |  | |/  \  " ' >>.bashrc
  echo 'echo -e "\t\033[91m    \_/  |_|   |____/      |_|  |_/_/\_\ " ' >>.bashrc
  echo 'wget -O /etc/versin_script_new https://raw.githubusercontent.com/seth42sp/VPS-MX_Oficial/main/SCRIPT-v8.5x%20Mod/Version &>/dev/null' >>.bashrc
  echo 'echo "" ' >>.bashrc
  echo 'mess1="$(less /etc/VPS-MX/message.txt)" ' >>.bashrc
  echo 'echo "" ' >>.bashrc
  echo 'echo -e "\t\033[92mPRO : $mess1 "' >>.bashrc
  echo 'echo -e "\t\e[1;33mVERSION: \e[1;31m$(cat /etc/versin_script_new)"' >>.bashrc
  echo 'echo "" ' >>.bashrc
  echo 'echo -e "\t\033[97mPARA PARA EXIBIR O TIPO DE PAINEL BASH: sudo VPSMX o menu "' >>.bashrc
  echo 'echo ""' >>.bashrc
  rm -rf /usr/bin/pytransform &>/dev/null
  rm -rf VPS-MX.sh
  rm -rf lista-arq
...
install_ADMRufu() {
  ...
  cd /etc
  wget https://raw.githubusercontent.com/seth42sp/Multi-Script/main/R9/ADMRufu.tar.xz >/dev/null 2>&1
  ...
  echo -e "[[ \$(date '+%s' -d \$up) -gt \$(date '+%s' -d \$(cat /etc/ADMRufu/vercion)) ]] && v2=\"Nova versão disponívele: \$v >>> \$up\" || v2=\"Script Vercion: \$v\"" >>/etc/bash.bashrc
...
install_ChumoGH() {
  ...
  cd /etc
  wget https://raw.githubusercontent.com/seth42sp/Multi-Script/main/ChuG/adm-lite.tar.xz >/dev/null 2>&1
  ...
  wget -q -O /bin/toolmain https://raw.githubusercontent.com/seth42sp/Multi-Script/main/ChuG/utilitarios/toolmain
  chmod +x /bin/toolmain
  echo 'source <(curl -sSL https://raw.githubusercontent.com/seth42sp/Multi-Script/main/ChuG/utilitarios/free-men.sh)' >/bin/ejecutar/echo-ram.sh
  echo 'wget -q -O /bin/ejecutar/v-new.log https://raw.githubusercontent.com/seth42sp/Multi-Script/main/ChuG/utilitarios/v-new.log' >>/bin/ejecutar/echo-ram.sh && bash /bin/ejecutar/echo-ram.sh
  ...
  echo 'echo -e " Data de instalação : " $(cat < /bin/ejecutar/fecha)' >>/root/.bashrc
  echo 'echo -e " Nome do servidor : $HOSTNAME"' >>/root/.bashrc
  echo 'echo -e " Horário on-line : $(uptime -p)"' >>/root/.bashrc
  echo 'echo -e " Memoria livre : $(cat < /bin/ejecutar/raml)"' >>/root/.bashrc
  echo 'echo -e " Dados do servidor : $DATE"' >>/root/.bashrc
  echo 'echo -e " Hora do Servidor : $TIME"' >>/root/.bashrc
  echo 'echo -e ""' >>/root/.bashrc
  echo 'echo -e " Bemvindo!"' >>.bashrc
  echo 'echo -e "\033[1;43m Tecle agora , menu o adm para ver o MENU\033[0m."' >>/root/.bashrc
  echo 'echo -e ""' >>/root/.bashrc
