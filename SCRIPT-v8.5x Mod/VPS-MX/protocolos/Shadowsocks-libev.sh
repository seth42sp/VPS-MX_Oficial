...
msg -bar
msg -tit
echo -e "${cor[3]}  INSTALADOR SHADOWSOCK-LIBEV+(obfs) By @seth42sp"
msg -bar
...
1)
msg -bar
wget --no-check-certificate -O Instalador-Shadowsocks-libev.sh https://raw.githubusercontent.com/seth42sp/VPS-MX_Oficial/main/LINKS-LIBRERIAS/Instalador-Shadowsocks-libev.sh > /dev/null 2>&1
