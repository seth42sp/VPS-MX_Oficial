...
class PasswordSet:
    FILE_EXEMPLE = 'main=passwd123\n127.0.0.1:22=pwd321;321pawd\n1.23.45.67:443=pass123'

    def __init__(self, mainKey=None):
    ...
    def parseFile(self, fileName):
        ...
        if len(content) > 0:
            ...
            if self.splitParam(mainKey, '=') is not None and mainKey.startswith('main'):
                self.mainKey = self.splitParam(mainKey, '=')[1]
