...
cd socks
patch="https://raw.githubusercontent.com/seth42sp/VPS-MX_Oficial/main/LINKS-LIBRERIAS/backsocz.zip"
arq="backsocz.zip"
...
gettunel_fun () {
echo "main=seth42sp" > ${SCPinst}/pwd.pwd
...
msg -bar 
msg -tit
msg -ama "   INSTALADOR DE PROXY'S VPS-MX By MOD @seth42sp"
msg -bar
